...
if __name__ == "__main__":
    ...
    if clientID != -1:
        ...
        #Get the robot handler and the red plane 22 object
        err_code, handler = sim.simxGetObjectHandle(clientID, 'Pioneer_p3dx', sim.simx_opmode_blocking)
        ...
        first_red =False #First time see the red
        last_red = False #Last time to see red
